...
public class CardUpdateDTO extends BaseDTO{
    ...
    public CardUpdateDTO(Long id, String cardName, String setName, String setNumber, Integer copies, Double price, String rarity) {
        this.setId(id);
